 ...
 */
@NamedQueries({
        @NamedQuery(name = Meal.UPDATE, query = "UPDATE Meal set description=:description, calories=:calories, dateTime=:dateTime WHERE id=:id and user.id=:userId"),
...
public class Meal extends BaseEntity {
    ...
    public static final String UPDATE = "Meal.updateOne";
    public static final String DELETE = "Meal.deleteOne";
